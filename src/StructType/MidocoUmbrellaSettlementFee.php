...
class MidocoUmbrellaSettlementFee extends UmbrellaSettlementFeeDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeStagger[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeStagger[] $midocoUmbrellaSettlementFeeStagger
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeStagger[]
     */
    ...
    public static function validateMidocoUmbrellaSettlementFeeStaggerForArrayConstraintFromSetMidocoUmbrellaSettlementFeeStagger(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaSettlementFeeMidocoUmbrellaSettlementFeeStaggerItem) {
            ...
            if (!$midocoUmbrellaSettlementFeeMidocoUmbrellaSettlementFeeStaggerItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeStagger) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUmbrellaSettlementFeeStagger property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeStagger, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeStagger $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFee
     */
    public function addToMidocoUmbrellaSettlementFeeStagger(\Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeStagger $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeStagger) {
            throw new InvalidArgumentException(sprintf('The MidocoUmbrellaSettlementFeeStagger property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeStagger, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateLocalizableMessageForArrayConstraintFromSetLocalizableMessage(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaSettlementFeeLocalizableMessageItem) {
            // validation for constraint: itemType
            if (!$midocoUmbrellaSettlementFeeLocalizableMessageItem instanceof \Pggns\MidocoApi\Bank\StructType\LocalizableMessageType) {
