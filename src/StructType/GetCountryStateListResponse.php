...
class GetCountryStateListResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCityForArrayConstraintFromSetMidocoCity(?array $values = []): string
    {
        ...
        foreach ($values as $getCountryStateListResponseMidocoCityItem) {
            ...
            if (!$getCountryStateListResponseMidocoCityItem instanceof \Pggns\MidocoApi\Bank\StructType\CityDTO) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\CityDTO[] $midocoCity
     * @return \Pggns\MidocoApi\Bank\StructType\GetCountryStateListResponse
     */
