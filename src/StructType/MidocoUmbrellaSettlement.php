...
class MidocoUmbrellaSettlement extends UmbrellaSettlementDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementPosition[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementPosition[] $midocoUmbrellaSettlementPosition
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementPosition[]
     */
    ...
    public static function validateMidocoUmbrellaSettlementPositionForArrayConstraintFromSetMidocoUmbrellaSettlementPosition(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaSettlementMidocoUmbrellaSettlementPositionItem) {
            ...
            if (!$midocoUmbrellaSettlementMidocoUmbrellaSettlementPositionItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementPosition) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUmbrellaSettlementPosition property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementPosition, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementPosition[] $midocoUmbrellaSettlementPosition
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlement
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementPosition $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlement
     */
    public function addToMidocoUmbrellaSettlementPosition(\Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementPosition $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementPosition) {
            throw new InvalidArgumentException(sprintf('The MidocoUmbrellaSettlementPosition property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementPosition, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
