...
class MidocoUmbrellaSettlementCustomer extends UmbrellaSettlementCustomerDTO
{
     ...
     * @param int $bexioContactId
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementCustomer
     */
     ...
     * @uses \Pggns\MidocoApi\Bank\EnumType\CustomerStatus::valueIsValid()
     * @uses \Pggns\MidocoApi\Bank\EnumType\CustomerStatus::getValidValues()
    ...
    public function setCustomerStatus(?string $customerStatus = null): self
    {
        ...
        if (!\Pggns\MidocoApi\Bank\EnumType\CustomerStatus::valueIsValid($customerStatus)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Bank\EnumType\CustomerStatus', is_array($customerStatus) ? implode(', ', $customerStatus) : var_export($customerStatus, true), implode(', ', \Pggns\MidocoApi\Bank\EnumType\CustomerStatus::getValidValues())), __LINE__);
        }
     ...
     * @uses \Pggns\MidocoApi\Bank\EnumType\InvoiceSettingStatus::valueIsValid()
     * @uses \Pggns\MidocoApi\Bank\EnumType\InvoiceSettingStatus::getValidValues()
     * @throws InvalidArgumentException
     * @param string $invoiceSettingStatus
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementCustomer
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Bank\EnumType\InvoiceSettingStatus::valueIsValid($invoiceSettingStatus)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Bank\EnumType\InvoiceSettingStatus', is_array($invoiceSettingStatus) ? implode(', ', $invoiceSettingStatus) : var_export($invoiceSettingStatus, true), implode(', ', \Pggns\MidocoApi\Bank\EnumType\InvoiceSettingStatus::getValidValues())), __LINE__);
        }
     ...
     * @uses \Pggns\MidocoApi\Bank\EnumType\SettlementSettingStatus::valueIsValid()
     * @uses \Pggns\MidocoApi\Bank\EnumType\SettlementSettingStatus::getValidValues()
     * @throws InvalidArgumentException
     * @param string $settlementSettingStatus
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementCustomer
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Bank\EnumType\SettlementSettingStatus::valueIsValid($settlementSettingStatus)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Bank\EnumType\SettlementSettingStatus', is_array($settlementSettingStatus) ? implode(', ', $settlementSettingStatus) : var_export($settlementSettingStatus, true), implode(', ', \Pggns\MidocoApi\Bank\EnumType\SettlementSettingStatus::getValidValues())), __LINE__);
        }
     ...
     * @uses \Pggns\MidocoApi\Bank\EnumType\UmbrellaSettlementImportFormat::valueIsValid()
     * @uses \Pggns\MidocoApi\Bank\EnumType\UmbrellaSettlementImportFormat::getValidValues()
     * @throws InvalidArgumentException
     * @param string $importFormat
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementCustomer
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Bank\EnumType\UmbrellaSettlementImportFormat::valueIsValid($importFormat)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Bank\EnumType\UmbrellaSettlementImportFormat', is_array($importFormat) ? implode(', ', $importFormat) : var_export($importFormat, true), implode(', ', \Pggns\MidocoApi\Bank\EnumType\UmbrellaSettlementImportFormat::getValidValues())), __LINE__);
        }
