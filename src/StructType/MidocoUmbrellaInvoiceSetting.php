...
class MidocoUmbrellaInvoiceSetting extends UmbrellaSettlementInvoiceSettingDTO
{
    ...
    public static function validateLocalizableMessageForArrayConstraintFromSetLocalizableMessage(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaInvoiceSettingLocalizableMessageItem) {
            ...
            if (!$midocoUmbrellaInvoiceSettingLocalizableMessageItem instanceof \Pggns\MidocoApi\Bank\StructType\LocalizableMessageType) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\LocalizableMessageType[] $localizableMessage
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaInvoiceSetting
     */
