...
class MidocoCrmCustomerPayment extends CrmCustomerPaymentDTO
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\CrmCustomerEinvoiceDTO $customerEInvoiceSetting = null, ?string $assignedDebitor = null, ?string $assignedCreditor = null, ?string $diverseDebitor = null, ?bool $makeNewOrder = null, ?bool $existDebitCards = null, ?string $currency = null, ?string $vatType = null)
    {
        $this
