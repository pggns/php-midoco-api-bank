...
class MidocoUmbrellaSettlementImport extends UmbrellaSettlementImportDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportColumnDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImportLine[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportColumnDTO[] $midocoUmbrellaSettlementImportColumn
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImportLine[] $midocoUmbrellaSettlementImportLine
     * @param int $totalRows
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportColumnDTO[]
     */
    ...
    public static function validateMidocoUmbrellaSettlementImportColumnForArrayConstraintFromSetMidocoUmbrellaSettlementImportColumn(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaSettlementImportMidocoUmbrellaSettlementImportColumnItem) {
            ...
            if (!$midocoUmbrellaSettlementImportMidocoUmbrellaSettlementImportColumnItem instanceof \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportColumnDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUmbrellaSettlementImportColumn property can only contain items of type \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportColumnDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportColumnDTO[] $midocoUmbrellaSettlementImportColumn
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImport
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportColumnDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImport
     */
    public function addToMidocoUmbrellaSettlementImportColumn(\Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportColumnDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportColumnDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoUmbrellaSettlementImportColumn property can only contain items of type \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportColumnDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImportLine[]
     */
    ...
    public static function validateMidocoUmbrellaSettlementImportLineForArrayConstraintFromSetMidocoUmbrellaSettlementImportLine(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaSettlementImportMidocoUmbrellaSettlementImportLineItem) {
            // validation for constraint: itemType
            if (!$midocoUmbrellaSettlementImportMidocoUmbrellaSettlementImportLineItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImportLine) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUmbrellaSettlementImportLine property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImportLine, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImportLine $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImport
     */
    public function addToMidocoUmbrellaSettlementImportLine(\Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImportLine $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImportLine) {
            throw new InvalidArgumentException(sprintf('The MidocoUmbrellaSettlementImportLine property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImportLine, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
