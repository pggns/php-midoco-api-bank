...
class GetAvailableAccountingSuppliersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoSupplierForArrayConstraintFromSetMidocoSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $getAvailableAccountingSuppliersResponseMidocoSupplierItem) {
            ...
            if (!$getAvailableAccountingSuppliersResponseMidocoSupplierItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoSupplierType) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoSupplierType[] $midocoSupplier
     * @return \Pggns\MidocoApi\Bank\StructType\GetAvailableAccountingSuppliersResponse
     */
