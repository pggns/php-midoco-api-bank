...
class BexioContactSynchronizationDetail extends BexioContactType
{
    ...
    /**
     * Set Action value
     * @uses \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationAction::valueIsValid()
     * @uses \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationAction::getValidValues()
     * @throws InvalidArgumentException
     * @param string $action
     * @return \Pggns\MidocoApi\Bank\StructType\BexioContactSynchronizationDetail
     */
    public function setAction(?string $action = null): self
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationAction::valueIsValid($action)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationAction', is_array($action) ? implode(', ', $action) : var_export($action, true), implode(', ', \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationAction::getValidValues())), __LINE__);
        }
        $this->Action = $action;
    ...
    /**
     * Set Result value
     * @uses \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationResult::valueIsValid()
     * @uses \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationResult::getValidValues()
     * @throws InvalidArgumentException
     * @param string $result
     * @return \Pggns\MidocoApi\Bank\StructType\BexioContactSynchronizationDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationResult::valueIsValid($result)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationResult', is_array($result) ? implode(', ', $result) : var_export($result, true), implode(', ', \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationResult::getValidValues())), __LINE__);
        }
        $this->Result = $result;
    ...
    public static function validateChangeAreaForArrayConstraintFromSetChangeArea(?array $values = []): string
    {
        ...
        foreach ($values as $bexioContactSynchronizationDetailChangeAreaItem) {
            // validation for constraint: enumeration
            if (!\Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationChangeArea::valueIsValid($bexioContactSynchronizationDetailChangeAreaItem)) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationChangeArea', is_array($invalidValues) ? implode(', ', $invalidValues) : var_export($invalidValues, true), implode(', ', \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationChangeArea::getValidValues()));
        }
        unset($invalidValues);
     ...
     * @uses \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationChangeArea::valueIsValid()
     * @uses \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationChangeArea::getValidValues()
     * @throws InvalidArgumentException
     * @param string[] $changeArea
     * @return \Pggns\MidocoApi\Bank\StructType\BexioContactSynchronizationDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationChangeArea::valueIsValid($item)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationChangeArea', is_array($item) ? implode(', ', $item) : var_export($item, true), implode(', ', \Pggns\MidocoApi\Bank\EnumType\BexioSynchronizationChangeArea::getValidValues())), __LINE__);
        }
