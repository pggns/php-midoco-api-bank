...
class MidocoUmbrellaSettlementFeeDefinition extends UmbrellaSettlementFeeDefinitionDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementFeeLocalizationDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementCsvColumnDTO[]
     */
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\LocalizableMessageType[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementFeeLocalizationDTO[] $midocoUmbrellaSettlementFeeLocalization
     * @param \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementCsvColumnDTO[] $midocoUmbrellaSettlementCsvColumn
     * @param \Pggns\MidocoApi\Bank\StructType\LocalizableMessageType[] $localizableMessage
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementFeeLocalizationDTO[]
     */
    ...
    public static function validateMidocoUmbrellaSettlementFeeLocalizationForArrayConstraintFromSetMidocoUmbrellaSettlementFeeLocalization(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaSettlementFeeDefinitionMidocoUmbrellaSettlementFeeLocalizationItem) {
            ...
            if (!$midocoUmbrellaSettlementFeeDefinitionMidocoUmbrellaSettlementFeeLocalizationItem instanceof \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementFeeLocalizationDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUmbrellaSettlementFeeLocalization property can only contain items of type \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementFeeLocalizationDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementFeeLocalizationDTO[] $midocoUmbrellaSettlementFeeLocalization
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeDefinition
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementFeeLocalizationDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeDefinition
     */
    public function addToMidocoUmbrellaSettlementFeeLocalization(\Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementFeeLocalizationDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementFeeLocalizationDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoUmbrellaSettlementFeeLocalization property can only contain items of type \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementFeeLocalizationDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementCsvColumnDTO[]
     */
    ...
    public static function validateMidocoUmbrellaSettlementCsvColumnForArrayConstraintFromSetMidocoUmbrellaSettlementCsvColumn(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaSettlementFeeDefinitionMidocoUmbrellaSettlementCsvColumnItem) {
            // validation for constraint: itemType
            if (!$midocoUmbrellaSettlementFeeDefinitionMidocoUmbrellaSettlementCsvColumnItem instanceof \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementCsvColumnDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUmbrellaSettlementCsvColumn property can only contain items of type \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementCsvColumnDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementCsvColumnDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeDefinition
     */
    public function addToMidocoUmbrellaSettlementCsvColumn(\Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementCsvColumnDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementCsvColumnDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoUmbrellaSettlementCsvColumn property can only contain items of type \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementCsvColumnDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateLocalizableMessageForArrayConstraintFromSetLocalizableMessage(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaSettlementFeeDefinitionLocalizableMessageItem) {
            // validation for constraint: itemType
            if (!$midocoUmbrellaSettlementFeeDefinitionLocalizableMessageItem instanceof \Pggns\MidocoApi\Bank\StructType\LocalizableMessageType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The LocalizableMessage property can only contain items of type \Pggns\MidocoApi\Bank\StructType\LocalizableMessageType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\LocalizableMessageType $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFeeDefinition
     */
    public function addToLocalizableMessage(\Pggns\MidocoApi\Bank\StructType\LocalizableMessageType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\LocalizableMessageType) {
            throw new InvalidArgumentException(sprintf('The LocalizableMessage property can only contain items of type \Pggns\MidocoApi\Bank\StructType\LocalizableMessageType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
