...
class GetFeeGroupAssignsRequest extends AbstractStructBase
{
     ...
     * @param bool $isValid
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\MidocoFeeGroupAssign $midocoFeeGroupAssign = null, ?array $groupId = null, ?bool $onlyFromOwnDb = false, ?bool $isValid = false)
    {
        $this
