...
class GetOrdCriteriaPredefinedValuesResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrdCriteriaPredefValForArrayConstraintFromSetMidocoOrdCriteriaPredefVal(?array $values = []): string
    {
        ...
        foreach ($values as $getOrdCriteriaPredefinedValuesResponseMidocoOrdCriteriaPredefValItem) {
            ...
            if (!$getOrdCriteriaPredefinedValuesResponseMidocoOrdCriteriaPredefValItem instanceof \Pggns\MidocoApi\Bank\StructType\OrdCriteriaPredefValDTO) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\OrdCriteriaPredefValDTO[] $midocoOrdCriteriaPredefVal
     * @return \Pggns\MidocoApi\Bank\StructType\GetOrdCriteriaPredefinedValuesResponse
     */
