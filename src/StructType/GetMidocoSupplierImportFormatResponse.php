...
class GetMidocoSupplierImportFormatResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\SupplierAgencyImportFormatDTO[]
     */
    ...
    public static function validateMidocoSupplierAgencyImportFormatForArrayConstraintFromSetMidocoSupplierAgencyImportFormat(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoSupplierImportFormatResponseMidocoSupplierAgencyImportFormatItem) {
            ...
            if (!$getMidocoSupplierImportFormatResponseMidocoSupplierAgencyImportFormatItem instanceof \Pggns\MidocoApi\Bank\StructType\SupplierAgencyImportFormatDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSupplierAgencyImportFormat property can only contain items of type \Pggns\MidocoApi\Bank\StructType\SupplierAgencyImportFormatDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\SupplierAgencyImportFormatDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\GetMidocoSupplierImportFormatResponse
     */
    public function addToMidocoSupplierAgencyImportFormat(\Pggns\MidocoApi\Bank\StructType\SupplierAgencyImportFormatDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\SupplierAgencyImportFormatDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoSupplierAgencyImportFormat property can only contain items of type \Pggns\MidocoApi\Bank\StructType\SupplierAgencyImportFormatDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
