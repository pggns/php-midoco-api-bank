...
class GetOrdCriteriaPredefinedValuesRequest extends AbstractStructBase
{
     ...
     */
    protected \Pggns\MidocoApi\Bank\StructType\MidocoOrdCriteriaType $MidocoOrdCriteriaType;
    /**
     * The name
     * @var string|null
     */
     ...
     * @param string $name
     */
    public function __construct(\Pggns\MidocoApi\Bank\StructType\MidocoOrdCriteriaType $midocoOrdCriteriaType, ?string $name = null)
    {
        $this
     ...
     */
    public function getMidocoOrdCriteriaType(): \Pggns\MidocoApi\Bank\StructType\MidocoOrdCriteriaType
    {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoOrdCriteriaType $midocoOrdCriteriaType
     * @return \Pggns\MidocoApi\Bank\StructType\GetOrdCriteriaPredefinedValuesRequest
     */
    public function setMidocoOrdCriteriaType(\Pggns\MidocoApi\Bank\StructType\MidocoOrdCriteriaType $midocoOrdCriteriaType): self
    {
