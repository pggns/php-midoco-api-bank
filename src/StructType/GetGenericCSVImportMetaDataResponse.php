...
class GetGenericCSVImportMetaDataResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\GenericCsvImportMetadataDTO[]
     */
    ...
    public static function validateMidocoGenericCsvImportMetadataForArrayConstraintFromSetMidocoGenericCsvImportMetadata(?array $values = []): string
    {
        ...
        foreach ($values as $getGenericCSVImportMetaDataResponseMidocoGenericCsvImportMetadataItem) {
            ...
            if (!$getGenericCSVImportMetaDataResponseMidocoGenericCsvImportMetadataItem instanceof \Pggns\MidocoApi\Bank\StructType\GenericCsvImportMetadataDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoGenericCsvImportMetadata property can only contain items of type \Pggns\MidocoApi\Bank\StructType\GenericCsvImportMetadataDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\GenericCsvImportMetadataDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\GetGenericCSVImportMetaDataResponse
     */
    public function addToMidocoGenericCsvImportMetadata(\Pggns\MidocoApi\Bank\StructType\GenericCsvImportMetadataDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\GenericCsvImportMetadataDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoGenericCsvImportMetadata property can only contain items of type \Pggns\MidocoApi\Bank\StructType\GenericCsvImportMetadataDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
