...
class MidocoUmbrellaSettlementSetting extends UmbrellaSettlementSettingDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementIncludedCustomer[]
     */
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFee[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementIncludedCustomer[] $midocoUmbrellaSettlementIncludedCustomer
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFee[] $midocoUmbrellaSettlementFee
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementIncludedCustomer[]
     */
    ...
    public static function validateMidocoUmbrellaSettlementIncludedCustomerForArrayConstraintFromSetMidocoUmbrellaSettlementIncludedCustomer(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaSettlementSettingMidocoUmbrellaSettlementIncludedCustomerItem) {
            ...
            if (!$midocoUmbrellaSettlementSettingMidocoUmbrellaSettlementIncludedCustomerItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementIncludedCustomer) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUmbrellaSettlementIncludedCustomer property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementIncludedCustomer, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementIncludedCustomer[] $midocoUmbrellaSettlementIncludedCustomer
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementSetting
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementIncludedCustomer $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementSetting
     */
    public function addToMidocoUmbrellaSettlementIncludedCustomer(\Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementIncludedCustomer $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementIncludedCustomer) {
            throw new InvalidArgumentException(sprintf('The MidocoUmbrellaSettlementIncludedCustomer property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementIncludedCustomer, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFee[]
     */
    ...
    public static function validateMidocoUmbrellaSettlementFeeForArrayConstraintFromSetMidocoUmbrellaSettlementFee(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaSettlementSettingMidocoUmbrellaSettlementFeeItem) {
            // validation for constraint: itemType
            if (!$midocoUmbrellaSettlementSettingMidocoUmbrellaSettlementFeeItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFee) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUmbrellaSettlementFee property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFee, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFee $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementSetting
     */
    public function addToMidocoUmbrellaSettlementFee(\Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFee $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFee) {
            throw new InvalidArgumentException(sprintf('The MidocoUmbrellaSettlementFee property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementFee, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateLocalizableMessageForArrayConstraintFromSetLocalizableMessage(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaSettlementSettingLocalizableMessageItem) {
            // validation for constraint: itemType
            if (!$midocoUmbrellaSettlementSettingLocalizableMessageItem instanceof \Pggns\MidocoApi\Bank\StructType\LocalizableMessageType) {
