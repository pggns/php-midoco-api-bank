...
class MidocoCustomerData extends CustomerDTO
{
     ...
     * - minOccurs: 0
     * - ref: MidocoCrmPerson
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoCrmPerson[]
     */
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoCrmCompany[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoCrmPerson[] $midocoCrmPerson
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCrmPerson[]
     */
    ...
    public static function validateMidocoCrmPersonForArrayConstraintFromSetMidocoCrmPerson(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoCrmPersonItem) {
            ...
            if (!$midocoCustomerDataMidocoCrmPersonItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoCrmPerson) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmPerson property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoCrmPerson, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoCrmPerson $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCustomerData
     */
    public function addToMidocoCrmPerson(\Pggns\MidocoApi\Bank\StructType\MidocoCrmPerson $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoCrmPerson) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmPerson property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoCrmPerson, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCrmCompany[]
     */
    ...
    public static function validateMidocoCrmCompanyForArrayConstraintFromSetMidocoCrmCompany(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerDataMidocoCrmCompanyItem) {
            // validation for constraint: itemType
            if (!$midocoCustomerDataMidocoCrmCompanyItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoCrmCompany) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCrmCompany property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoCrmCompany, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoCrmCompany $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCustomerData
     */
    public function addToMidocoCrmCompany(\Pggns\MidocoApi\Bank\StructType\MidocoCrmCompany $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoCrmCompany) {
            throw new InvalidArgumentException(sprintf('The MidocoCrmCompany property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoCrmCompany, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
