...
class SaveSupplierOrdCritValueResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrdCriteriaValueForArrayConstraintFromSetMidocoOrdCriteriaValue(?array $values = []): string
    {
        ...
        foreach ($values as $saveSupplierOrdCritValueResponseMidocoOrdCriteriaValueItem) {
            ...
            if (!$saveSupplierOrdCritValueResponseMidocoOrdCriteriaValueItem instanceof \Pggns\MidocoApi\Bank\StructType\OrdCriteriaValueDTO) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\OrdCriteriaValueDTO[] $midocoOrdCriteriaValue
     * @return \Pggns\MidocoApi\Bank\StructType\SaveSupplierOrdCritValueResponse
     */
