...
class ExternalCustomerInfo extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoCrmDebitCard|null
     */
    protected ?\Pggns\MidocoApi\Bank\StructType\MidocoCrmDebitCard $MidocoCrmDebitCard = null;
    /**
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoCrmCustomer $midocoCrmCustomer
     * @return \Pggns\MidocoApi\Bank\StructType\ExternalCustomerInfo
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCrmDebitCard|null
     */
    public function getMidocoCrmDebitCard(): ?\Pggns\MidocoApi\Bank\StructType\MidocoCrmDebitCard
    {
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\ExternalCustomerInfo
     */
    public function setMidocoCrmDebitCard(?\Pggns\MidocoApi\Bank\StructType\MidocoCrmDebitCard $midocoCrmDebitCard = null): self
    {
    ...
    public static function validateMidocoCrmCriteriaForArrayConstraintFromSetMidocoCrmCriteria(?array $values = []): string
    {
        ...
        foreach ($values as $externalCustomerInfoMidocoCrmCriteriaItem) {
            ...
            if (!$externalCustomerInfoMidocoCrmCriteriaItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoCrmCriteria) {
    ...
    public static function validateMidocoContactEntryForArrayConstraintFromSetMidocoContactEntry(?array $values = []): string
    {
        ...
        foreach ($values as $externalCustomerInfoMidocoContactEntryItem) {
            // validation for constraint: itemType
            if (!$externalCustomerInfoMidocoContactEntryItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoContactEntryType) {
