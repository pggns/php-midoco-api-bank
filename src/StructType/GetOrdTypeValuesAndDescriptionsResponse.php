...
class GetOrdTypeValuesAndDescriptionsResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\OrdCriteriaPredefValDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\OrdCriteriaPredefValDTO[] $midocoOrdCriteriaPredefVal
     */
    ...
    public static function validateMidocoOrdCriteriaDescriptionForArrayConstraintFromSetMidocoOrdCriteriaDescription(?array $values = []): string
    {
        ...
        foreach ($values as $getOrdTypeValuesAndDescriptionsResponseMidocoOrdCriteriaDescriptionItem) {
            // validation for constraint: itemType
            if (!$getOrdTypeValuesAndDescriptionsResponseMidocoOrdCriteriaDescriptionItem instanceof \Pggns\MidocoApi\Bank\StructType\OrdCriteriaDescriptionDTO) {
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\OrdCriteriaPredefValDTO[]
     */
    ...
    public static function validateMidocoOrdCriteriaPredefValForArrayConstraintFromSetMidocoOrdCriteriaPredefVal(?array $values = []): string
    {
        ...
        foreach ($values as $getOrdTypeValuesAndDescriptionsResponseMidocoOrdCriteriaPredefValItem) {
            // validation for constraint: itemType
            if (!$getOrdTypeValuesAndDescriptionsResponseMidocoOrdCriteriaPredefValItem instanceof \Pggns\MidocoApi\Bank\StructType\OrdCriteriaPredefValDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoOrdCriteriaPredefVal property can only contain items of type \Pggns\MidocoApi\Bank\StructType\OrdCriteriaPredefValDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\OrdCriteriaPredefValDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\GetOrdTypeValuesAndDescriptionsResponse
     */
    public function addToMidocoOrdCriteriaPredefVal(\Pggns\MidocoApi\Bank\StructType\OrdCriteriaPredefValDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\OrdCriteriaPredefValDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoOrdCriteriaPredefVal property can only contain items of type \Pggns\MidocoApi\Bank\StructType\OrdCriteriaPredefValDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
