...
class GetAllCitiesFromStateResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCityForArrayConstraintFromSetMidocoCity(?array $values = []): string
    {
        ...
        foreach ($values as $getAllCitiesFromStateResponseMidocoCityItem) {
            ...
            if (!$getAllCitiesFromStateResponseMidocoCityItem instanceof \Pggns\MidocoApi\Bank\StructType\CityDTO) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\CityDTO[] $midocoCity
     * @return \Pggns\MidocoApi\Bank\StructType\GetAllCitiesFromStateResponse
     */
