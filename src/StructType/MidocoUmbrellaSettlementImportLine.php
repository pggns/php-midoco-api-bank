...
class MidocoUmbrellaSettlementImportLine extends UmbrellaSettlementImportLineDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportValueDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportValueDTO[] $midocoUmbrellaSettlementImportValue
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportValueDTO[]
     */
    ...
    public static function validateMidocoUmbrellaSettlementImportValueForArrayConstraintFromSetMidocoUmbrellaSettlementImportValue(?array $values = []): string
    {
        ...
        foreach ($values as $midocoUmbrellaSettlementImportLineMidocoUmbrellaSettlementImportValueItem) {
            ...
            if (!$midocoUmbrellaSettlementImportLineMidocoUmbrellaSettlementImportValueItem instanceof \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportValueDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUmbrellaSettlementImportValue property can only contain items of type \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportValueDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportValueDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementImportLine
     */
    public function addToMidocoUmbrellaSettlementImportValue(\Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportValueDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportValueDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoUmbrellaSettlementImportValue property can only contain items of type \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementImportValueDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
