...
class SaveSupplierOrdCritValueRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoOrdCriteriaValueForArrayConstraintFromSetMidocoOrdCriteriaValue(?array $values = []): string
    {
        ...
        foreach ($values as $saveSupplierOrdCritValueRequestMidocoOrdCriteriaValueItem) {
            ...
            if (!$saveSupplierOrdCritValueRequestMidocoOrdCriteriaValueItem instanceof \Pggns\MidocoApi\Bank\StructType\OrdCriteriaValueDTO) {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\OrdCriteriaValueDTO[] $midocoOrdCriteriaValue
     * @return \Pggns\MidocoApi\Bank\StructType\SaveSupplierOrdCritValueRequest
     */
