...
class UmbrellaSettlementCustomersType extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementCustomer[]
     */
    ...
    public static function validateMidocoUmbrellaSettlementCustomerForArrayConstraintFromSetMidocoUmbrellaSettlementCustomer(?array $values = []): string
    {
        ...
        foreach ($values as $umbrellaSettlementCustomersTypeMidocoUmbrellaSettlementCustomerItem) {
            ...
            if (!$umbrellaSettlementCustomersTypeMidocoUmbrellaSettlementCustomerItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementCustomer) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUmbrellaSettlementCustomer property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementCustomer, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementCustomer[] $midocoUmbrellaSettlementCustomer
     * @return \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementCustomersType
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementCustomer $item
     * @return \Pggns\MidocoApi\Bank\StructType\UmbrellaSettlementCustomersType
     */
    public function addToMidocoUmbrellaSettlementCustomer(\Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementCustomer $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementCustomer) {
            throw new InvalidArgumentException(sprintf('The MidocoUmbrellaSettlementCustomer property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoUmbrellaSettlementCustomer, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
